...
const registerValidation = [
  body("name")
    .isLength({ min: 12 })
    .withMessage("Name must be at least 12 Characters long"),
  ...
  body("password")
    ...
    .withMessage(
      "Password should be at least 12 character long having at least 1special char, number, lower and uppercase letter."
    ),
];
